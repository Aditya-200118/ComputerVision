...
def threshold_dual_region_growing(image, sigma_fg):
    """
    Task 3: Dual thresholding with region growing.
    T_H is found automatically via iterative variance separation. 
    T_L is calculated dynamically using the profile-derived intra-class variance (sigma_fg).
    """
    ...
    # 2. Heuristic Low Threshold (T_L) using Profile Data
...
if __name__ == "__main__":
    output_dir = "assignment3_ver4_figures"
