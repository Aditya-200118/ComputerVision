...
\subsubsection{Algorithm Overview}
This algorithm iteratively converges on a threshold. It splits the image into two groups (foreground and background) based on an initial estimate, calculates the mean of both groups, and updates the threshold to the midpoint of those means until convergence ($\Delta T < 1.0$).
...
Image \texttt{test1.img} presents a relatively balanced illumination profile with a mild negative kurtosis of -0.617[cite: 63]. The dynamic heuristics successfully relaxed the height ratio to accommodate the balanced lighting.
...
\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{assignment3_profiling_ver3/test1_height_analysis.pdf}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{assignment3_profiling_ver3/test2_height_analysis.pdf}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{assignment3_profiling_ver3/test3_height_analysis.pdf}
    \end{subfigure}
