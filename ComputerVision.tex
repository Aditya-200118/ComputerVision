...
\begin{itemize}
    ...
    \item Robustness to noise or other artifacts
\end{itemize}

Access to ground truth data

- reliability generated in restricted domains
- in unrestricted or loosely restricted domains - crowdsourcing (with compensation)
-- annotation bias
-- demographics of annotators
-- screening for wrong/malacious annotation
...
Figure of merit (Pratt Figure of merit)

\begin{equation}
    PFM = \frac{1}{max(I_A, I_I)} \sum_{i=1}^{I_A}\frac{1}{\alpha d_i^2+ 1}
\end{equation}

$I_a$; a detected edge II 
