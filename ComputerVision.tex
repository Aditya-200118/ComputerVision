...
\textbf{Edge} \\
Location of $\underbrace{\text{significant change}}_{\text{rate of change}}$ in a "local image property" \\
...
\end{equation}
\begin{equation}
    f_{\circ} = \underbrace{f(t)}_{\text{signal}} + \underbrace{n(t)}_{\text{noise}}
\end{equation}
\begin{equation}
    \frac{df_{\circ}(t)}{dt} = \frac{df(t)}{dt}+\frac{dx(t)}{dt}
\end{equation}

\[
f(t)=A_{S} \sin(2\pi f_{S}t)
\] 

\[
n(t)=A_{n} \sin(2\pi f_{n}t)
\] 

\[
f_{\circ}(t) = A_{S} \sin(2\pi f_{S}t) + A_{n} \sin(2\pi f_{n}t)
\] 
